...
python run.py  --dataset_name laptop_singer  --pure_bert --embedding_type bert --output_dir ../output/zy-pair --log_file singer-purebert_droput0.3_20220804.log --eval_file singer_eval_results_purebert_droput0.3_20220804.txt --dropout 0.3 --hidden_size 200 --learning_rate 5e-5
